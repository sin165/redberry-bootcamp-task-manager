<x-frame>
    <div class="relative pr-10 pt-16">
        <div class="w-2/5 min-w-80 mx-auto -translate-x-5 mt-6">
            ...
            <form class="flex flex-col gap-6 mb-14" method="POST" action="{{ route('tasks.store') }}">
                @csrf
                @method('PATCH')
                ...
                <fieldset class="flex items-center gap-5">
                    ...
                    <button class="font-bold leading-4 rounded-1.5xl flex gap-2 items-center px-12 py-4 border border-blue-primary text-blue-primary hover:bg-blue-transparent">
                        <x-svg.upload />
